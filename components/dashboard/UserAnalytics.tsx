...
import type { StageDetail, UserProfile } from '@/types';
...
export default function UserAnalytics({ stages, userRows, userOverallRows = [], userProfiles = [], chartData, selectedUser, onSelectUser }: UserAnalyticsProps) {
  return (
    <div className="flex flex-col gap-6">
      <StageTable stages={stages} />
      <StageComparison stages={stages} />
      <StageTotals chartData={chartData} stages={stages} />
      <PerUserOverview userOverallRows={userOverallRows} userProfiles={userProfiles} selectedUser={selectedUser} />
